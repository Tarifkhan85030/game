...
rock_img = ImageTk.PhotoImage(Image.open("img/rockman.png"))
paper_img = ImageTk.PhotoImage(Image.open("img/paperman.png"))
scissor_img = ImageTk.PhotoImage(Image.open("img/secssorman.png").rotate(-90))

# load images for computer choices
com_rock_img = ImageTk.PhotoImage(Image.open("img/rock.jpg").rotate(90))
com_paper_img = ImageTk.PhotoImage(Image.open("img/paper.jpg").rotate(90))
com_scissor_img = ImageTk.PhotoImage(Image.open("img/secssor.jpg").rotate(90))
